...
// Sample usage.
/*
#include <RCF/rcfutil/NtService.hpp>

#include <RCF/rcfutil/../../../src/RCF/rcfutil/NtService.cpp>

class MyService : public rcfutil::NtService
{
public:

    MyService() : rcfutil::NtService("MyService", "My Really Useful Service")
    {
    }
