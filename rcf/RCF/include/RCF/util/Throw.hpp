    ...
    public:
        ...
        ~ThrowFunctor()
        {
            ...
            if (!mThrown)
            {
                ...
                if (!rcfutil::detail::uncaught_exception())
                {
...
#define UTIL_THROW_GCC_33_HACK (const rcfutil::VariableArgMacro<rcfutil::ThrowFunctor> &)
#else
...
#define UTIL_THROW(e, logName, logLevel)                                    \
    while (true)                                                            \
        ...
        rcfutil::VariableArgMacro<rcfutil::ThrowFunctor>(e, logName, logLevel)    \
            .init(                                                          \
                "",                                                         \
                "",                                                         \
                __FILE__,                                                   \
            ...
            .cast( (rcfutil::VariableArgMacro<rcfutil::ThrowFunctor> *) NULL)     \
            .UTIL_THROW_A
